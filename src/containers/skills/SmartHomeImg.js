  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {/* Ground/Base */}
        <rect x="0" y="300" width="864.81" height="158.45" fill="#28a745" opacity="0.1" />
        <rect x="0" y="380" width="864.81" height="78.45" fill="#198754" opacity="0.1" />
        
        {/* Main House Structure - Flat Roof */}
        <rect x="220" y="100" width="424" height="200" fill="url(#house-gradient)" stroke="#dee2e6" strokeWidth="2" />
        
        {/* Door */}
        <rect x="400" y="220" width="64" height="80" fill="#6c757d" rx="5" />
        <circle cx="450" cy="260" r="3" fill="#ffc107" />
        
        {/* Windows */}
        <rect x="260" y="140" width="60" height="60" fill="#87ceeb" stroke="#495057" strokeWidth="2" rx="5" />
        <rect x="544" y="140" width="60" height="60" fill="#87ceeb" stroke="#495057" strokeWidth="2" rx="5" />
        <line x1="290" y1="140" x2="290" y2="200" stroke="#495057" strokeWidth="1" />
        <line x1="260" y1="170" x2="320" y2="170" stroke="#495057" strokeWidth="1" />
        <line x1="574" y1="140" x2="574" y2="200" stroke="#495057" strokeWidth="1" />
        <line x1="544" y1="170" x2="604" y2="170" stroke="#495057" strokeWidth="1" />
        
        {/* Garage */}
        <rect x="240" y="220" width="100" height="80" fill="#adb5bd" stroke="#6c757d" strokeWidth="2" />
        <rect x="250" y="260" width="80" height="2" fill="#495057" />
        <rect x="250" y="270" width="80" height="2" fill="#495057" />
        <rect x="250" y="280" width="80" height="2" fill="#495057" />
        
        {/* Smart Devices on House */}
        
        {/* Smart Doorbell */}
        <rect x="375" y="250" width="12" height="18" fill="#343a40" rx="2" />
        <circle cx="381" cy="256" r="2" fill="#dc3545" />
        <circle cx="381" cy="262" r="1" fill="#ffc107" />
        
        {/* Smart Thermostat */}
        <circle cx="500" cy="180" r="15" fill="#fff" stroke="#495057" strokeWidth="2" />
        <circle cx="500" cy="180" r="8" fill={theme.imageHighlight} />
        <text x="500" y="185" textAnchor="middle" fontSize="8" fill="#fff">72°</text>
        
        {/* Smart Light Switch */}
        <rect x="555" y="250" width="15" height="25" fill="#fff" stroke="#495057" strokeWidth="1" rx="2" />
        <rect x="558" y="255" width="9" height="6" fill={theme.imageHighlight} rx="1" />
        <rect x="558" y="264" width="9" height="6" fill="#e9ecef" rx="1" />
        
        {/* Smart Outlet */}
        <rect x="270" y="270" width="18" height="12" fill="#fff" stroke="#495057" strokeWidth="1" rx="2" />
        <circle cx="276" cy="276" r="1.5" fill="#495057" />
        <circle cx="282" cy="276" r="1.5" fill="#495057" />
        
        {/* WiFi Router (inside house, visible through window) */}
        <rect x="575" y="185" width="20" height="8" fill="#343a40" />
        <circle cx="580" cy="189" r="1" fill="#28a745" />
        <circle cx="585" cy="189" r="1" fill="#ffc107" />
        <circle cx="590" cy="189" r="1" fill="#28a745" />
